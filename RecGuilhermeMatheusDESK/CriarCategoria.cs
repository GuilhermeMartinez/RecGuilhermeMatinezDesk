...
namespace RecGuilhermeMatheusDESK
{
    ...
    { // CONEXÃO COM O BANCO DE DADOS
        SqlConnection conn = new SqlConnection(@"workstation id=GuilhermeM.mssql.somee.com;packet size=4096;user id=GuilhermeM_SQLLogin_1;pwd=jvq6jisxgl;data source=GuilhermeM.mssql.somee.com;persist security info=False;initial catalog=GuilhermeM");
